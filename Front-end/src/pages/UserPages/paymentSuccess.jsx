...
function PaymentSuccess() {
    ...
    return (
        <>
            ...
            <div class="grid h-screen place-content-center bg-blue-500 px-4 dark:bg-gray-900">
                <h1 class="uppercase tracking-widest text-green-400 font-medium text-3xl cursor-pointer">Payment Success</h1>
                <h1 class="uppercase tracking-widest text-blue-400 font-medium text-2xl cursor-pointer"
